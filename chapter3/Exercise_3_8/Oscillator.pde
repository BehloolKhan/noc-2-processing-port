...
class Oscillator {
  PVector angle, angleVelocity, amplitude, angularAcceleration;
  ...
  Oscillator() {
    ...
    this.angularAcceleration = new PVector(random(-0.001, 0.001), random(-0.001, 0.001));
  }

  void update() {

    this.angleVelocity.add(this.angularAcceleration);
